...
/** Compact programme phasing bar for the title block — segments sized by weeks, handover in brass. */
        ...
        {timeline.map((phase, i) => {
          ...
          return (
            <li key={phase.key} className="flex flex-col gap-0.5">
              <span className={`tabular-nums ${last ? 'text-brass' : 'text-ink'}`}>{phase.weeks}w</span>
